...
public class SWRG extends ItemPE implements IBauble, IPedestalItem, IFlightProvider {
    ...
    public List<String> getPedestalDescription()
    {
        ...
        if (ProjectEConfig.swrgPedCooldown != -1)
        {
            ...
            list.add(EnumChatFormatting.BLUE + String.format(StatCollector.translateToLocal("pe.swrg.pedestal2"), MathUtils.tickToSecFormatted(ProjectEConfig.swrgPedCooldown)));
        }
        return list;
    }
}
