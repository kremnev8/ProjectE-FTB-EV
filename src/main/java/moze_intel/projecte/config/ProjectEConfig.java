...
public final class ProjectEConfig {
	...
	public static boolean enableUnlearnSlot;
	...
	public static boolean adminPermForEMCModif;
	...
	public static void init(File configFile)
	{
		...
		try
		{
			...
			enableUnlearnSlot = config.getBoolean("enableUnlearnSlot", "misc", false, "Enable unlearn slot in transmutation table");
			adminPermForEMCModif = config.getBoolean("adminPermForEMCModif", "misc", false, "Is needed admin permission to edit EMC values for items (if you playing on FTB map DO NOT touch this!)");
